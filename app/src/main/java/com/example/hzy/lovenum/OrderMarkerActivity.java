 ...
 */
public class OrderMarkerActivity extends Activity implements OnClickListener {
	private MarkerOptions markerOption; //标记点的配置
	private AMap aMap; //操作地图的对象
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ordermarker_activity); //设置前台显示文件
		/*
